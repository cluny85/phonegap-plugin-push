...
/**
 * Clear the application notification
 */

PushNotification.prototype.clearNotification = function(successCallback, errorCallback, id) {
    if (!successCallback) { successCallback = function() {}; }
    if (!errorCallback) { errorCallback = function() {}; }
    ...
    exec(successCallback, errorCallback, 'PushNotification', 'clearNotification', [{id:id}]);
};
/**
 * Listen for an event.
 *
